...
#LABEL image="https://hub.docker.com/r/valentincolin/website"            # pas encore push sur le hub
#LABEL source="https://github.com/valentincolin/website"                 # privée pour le moment
...
HEALTHCHECK --interval=30s \
            ...
            --start-period=1m \
            --retries=3 \
             CMD curl -sSf http://127.0.0.1:$PORT || exit 1
